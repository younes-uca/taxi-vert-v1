...
import { CourseChauffeurModule } from './view/course/course-chauffeur.module';
import { CourseChauffeurRoutingModule } from './view/course/course-chauffeur-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  CourseChauffeurModule,
  CourseChauffeurRoutingModule,
  ],
  exports: [
  LoginChauffeurComponent,
  RegisterChauffeurComponent,
