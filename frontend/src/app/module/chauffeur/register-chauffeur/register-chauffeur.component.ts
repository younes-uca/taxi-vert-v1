...
@Component({
  ...
  styleUrls: ['./register-chauffeur.component.scss']
})
export class RegisterChauffeurComponent implements OnInit {
  ...
  submit(){
    ...
    this.authService.registerChauffeur();
