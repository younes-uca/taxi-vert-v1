...
@Component({
  selector: 'app-etat-chauffeur-edit-chauffeur',
  templateUrl: './etat-chauffeur-edit-chauffeur.component.html',
  styleUrls: ['./etat-chauffeur-edit-chauffeur.component.css']
})
export class EtatChauffeurEditChauffeurComponent implements OnInit {
