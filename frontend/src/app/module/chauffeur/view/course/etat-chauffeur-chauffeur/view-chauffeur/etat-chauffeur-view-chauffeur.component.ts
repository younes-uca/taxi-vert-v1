...
@Component({
  selector: 'app-etat-chauffeur-view-chauffeur',
  templateUrl: './etat-chauffeur-view-chauffeur.component.html',
  styleUrls: ['./etat-chauffeur-view-chauffeur.component.css']
})
export class EtatChauffeurViewChauffeurComponent implements OnInit {
