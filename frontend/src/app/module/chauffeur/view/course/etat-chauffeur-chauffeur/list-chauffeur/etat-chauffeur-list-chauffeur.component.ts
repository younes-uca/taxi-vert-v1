...
@Component({
  selector: 'app-etat-chauffeur-list-chauffeur',
  templateUrl: './etat-chauffeur-list-chauffeur.component.html',
  styleUrls: ['./etat-chauffeur-list-chauffeur.component.css']
})
export class EtatChauffeurListChauffeurComponent implements OnInit {
   // declarations
