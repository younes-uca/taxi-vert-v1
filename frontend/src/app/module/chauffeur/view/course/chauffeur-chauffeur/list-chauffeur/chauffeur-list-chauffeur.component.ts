...
@Component({
  selector: 'app-chauffeur-list-chauffeur',
  templateUrl: './chauffeur-list-chauffeur.component.html',
  styleUrls: ['./chauffeur-list-chauffeur.component.css']
})
export class ChauffeurListChauffeurComponent implements OnInit {
   // declarations
