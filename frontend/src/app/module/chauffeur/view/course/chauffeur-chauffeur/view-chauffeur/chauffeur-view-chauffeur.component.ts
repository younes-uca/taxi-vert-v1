...
@Component({
  selector: 'app-chauffeur-view-chauffeur',
  templateUrl: './chauffeur-view-chauffeur.component.html',
  styleUrls: ['./chauffeur-view-chauffeur.component.css']
})
export class ChauffeurViewChauffeurComponent implements OnInit {
