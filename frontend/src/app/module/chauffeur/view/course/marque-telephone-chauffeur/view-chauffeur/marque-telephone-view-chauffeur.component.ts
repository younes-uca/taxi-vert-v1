...
@Component({
  selector: 'app-marque-telephone-view-chauffeur',
  templateUrl: './marque-telephone-view-chauffeur.component.html',
  styleUrls: ['./marque-telephone-view-chauffeur.component.css']
})
export class MarqueTelephoneViewChauffeurComponent implements OnInit {
