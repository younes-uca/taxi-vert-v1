...
@Component({
  selector: 'app-marque-telephone-list-chauffeur',
  templateUrl: './marque-telephone-list-chauffeur.component.html',
  styleUrls: ['./marque-telephone-list-chauffeur.component.css']
})
export class MarqueTelephoneListChauffeurComponent implements OnInit {
   // declarations
