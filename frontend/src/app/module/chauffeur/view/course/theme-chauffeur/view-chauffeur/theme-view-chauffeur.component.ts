...
@Component({
  selector: 'app-theme-view-chauffeur',
  templateUrl: './theme-view-chauffeur.component.html',
  styleUrls: ['./theme-view-chauffeur.component.css']
})
export class ThemeViewChauffeurComponent implements OnInit {
