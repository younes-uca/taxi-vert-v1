...
@Component({
  selector: 'app-secteur-edit-chauffeur',
  templateUrl: './secteur-edit-chauffeur.component.html',
  styleUrls: ['./secteur-edit-chauffeur.component.css']
})
export class SecteurEditChauffeurComponent implements OnInit {
