...
@Component({
  selector: 'app-secteur-view-chauffeur',
  templateUrl: './secteur-view-chauffeur.component.html',
  styleUrls: ['./secteur-view-chauffeur.component.css']
})
export class SecteurViewChauffeurComponent implements OnInit {
