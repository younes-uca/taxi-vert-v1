...
@Component({
  selector: 'app-operateur-list-chauffeur',
  templateUrl: './operateur-list-chauffeur.component.html',
  styleUrls: ['./operateur-list-chauffeur.component.css']
})
export class OperateurListChauffeurComponent implements OnInit {
   // declarations
