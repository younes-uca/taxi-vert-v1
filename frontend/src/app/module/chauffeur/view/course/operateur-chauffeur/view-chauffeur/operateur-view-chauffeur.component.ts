...
@Component({
  selector: 'app-operateur-view-chauffeur',
  templateUrl: './operateur-view-chauffeur.component.html',
  styleUrls: ['./operateur-view-chauffeur.component.css']
})
export class OperateurViewChauffeurComponent implements OnInit {
