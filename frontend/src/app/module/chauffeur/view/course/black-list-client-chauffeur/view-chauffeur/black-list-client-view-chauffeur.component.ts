...
@Component({
  selector: 'app-black-list-client-view-chauffeur',
  templateUrl: './black-list-client-view-chauffeur.component.html',
  styleUrls: ['./black-list-client-view-chauffeur.component.css']
})
export class BlackListClientViewChauffeurComponent implements OnInit {
