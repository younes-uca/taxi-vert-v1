...
@Component({
  selector: 'app-langue-view-chauffeur',
  templateUrl: './langue-view-chauffeur.component.html',
  styleUrls: ['./langue-view-chauffeur.component.css']
})
export class LangueViewChauffeurComponent implements OnInit {
