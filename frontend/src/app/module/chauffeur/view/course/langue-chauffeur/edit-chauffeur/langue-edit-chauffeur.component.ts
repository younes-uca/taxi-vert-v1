...
@Component({
  selector: 'app-langue-edit-chauffeur',
  templateUrl: './langue-edit-chauffeur.component.html',
  styleUrls: ['./langue-edit-chauffeur.component.css']
})
export class LangueEditChauffeurComponent implements OnInit {
