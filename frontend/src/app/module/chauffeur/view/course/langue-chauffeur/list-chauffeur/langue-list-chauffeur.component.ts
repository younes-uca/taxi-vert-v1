...
@Component({
  selector: 'app-langue-list-chauffeur',
  templateUrl: './langue-list-chauffeur.component.html',
  styleUrls: ['./langue-list-chauffeur.component.css']
})
export class LangueListChauffeurComponent implements OnInit {
   // declarations
