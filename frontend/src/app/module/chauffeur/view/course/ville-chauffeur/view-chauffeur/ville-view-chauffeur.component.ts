...
@Component({
  selector: 'app-ville-view-chauffeur',
  templateUrl: './ville-view-chauffeur.component.html',
  styleUrls: ['./ville-view-chauffeur.component.css']
})
export class VilleViewChauffeurComponent implements OnInit {
