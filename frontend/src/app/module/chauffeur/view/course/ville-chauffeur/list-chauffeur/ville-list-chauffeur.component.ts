...
@Component({
  selector: 'app-ville-list-chauffeur',
  templateUrl: './ville-list-chauffeur.component.html',
  styleUrls: ['./ville-list-chauffeur.component.css']
})
export class VilleListChauffeurComponent implements OnInit {
   // declarations
