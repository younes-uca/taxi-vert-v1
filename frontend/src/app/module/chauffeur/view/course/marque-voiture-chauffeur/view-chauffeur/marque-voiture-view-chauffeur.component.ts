...
@Component({
  selector: 'app-marque-voiture-view-chauffeur',
  templateUrl: './marque-voiture-view-chauffeur.component.html',
  styleUrls: ['./marque-voiture-view-chauffeur.component.css']
})
export class MarqueVoitureViewChauffeurComponent implements OnInit {
