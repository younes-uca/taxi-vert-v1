...
@Component({
  selector: 'app-marque-voiture-list-chauffeur',
  templateUrl: './marque-voiture-list-chauffeur.component.html',
  styleUrls: ['./marque-voiture-list-chauffeur.component.css']
})
export class MarqueVoitureListChauffeurComponent implements OnInit {
   // declarations
