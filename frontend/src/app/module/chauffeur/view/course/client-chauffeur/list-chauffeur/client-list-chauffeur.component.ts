...
@Component({
  selector: 'app-client-list-chauffeur',
  templateUrl: './client-list-chauffeur.component.html',
  styleUrls: ['./client-list-chauffeur.component.css']
})
export class ClientListChauffeurComponent implements OnInit {
   // declarations
