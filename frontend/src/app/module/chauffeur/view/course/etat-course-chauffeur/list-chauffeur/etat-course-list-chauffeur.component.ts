...
@Component({
  selector: 'app-etat-course-list-chauffeur',
  templateUrl: './etat-course-list-chauffeur.component.html',
  styleUrls: ['./etat-course-list-chauffeur.component.css']
})
export class EtatCourseListChauffeurComponent implements OnInit {
   // declarations
