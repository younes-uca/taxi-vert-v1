...
@Component({
  selector: 'app-etat-course-edit-chauffeur',
  templateUrl: './etat-course-edit-chauffeur.component.html',
  styleUrls: ['./etat-course-edit-chauffeur.component.css']
})
export class EtatCourseEditChauffeurComponent implements OnInit {
