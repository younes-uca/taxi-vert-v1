...
@Component({
  selector: 'app-etat-course-view-chauffeur',
  templateUrl: './etat-course-view-chauffeur.component.html',
  styleUrls: ['./etat-course-view-chauffeur.component.css']
})
export class EtatCourseViewChauffeurComponent implements OnInit {
