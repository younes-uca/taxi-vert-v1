...
@Component({
  selector: 'app-course-view-chauffeur',
  templateUrl: './course-view-chauffeur.component.html',
  styleUrls: ['./course-view-chauffeur.component.css']
})
export class CourseViewChauffeurComponent implements OnInit {
