...
@Component({
  selector: 'app-course-list-chauffeur',
  templateUrl: './course-list-chauffeur.component.html',
  styleUrls: ['./course-list-chauffeur.component.css']
})
export class CourseListChauffeurComponent implements OnInit {
   // declarations
