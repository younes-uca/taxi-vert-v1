...
@Component({
  selector: 'app-course-edit-chauffeur',
  templateUrl: './course-edit-chauffeur.component.html',
  styleUrls: ['./course-edit-chauffeur.component.css']
})
export class CourseEditChauffeurComponent implements OnInit {

    _submitted = false;
    private _errorMessages = new Array<string>();


    _validSecteurSourceLibelle = true;
    _validSecteurSourceCode = true;
    _validSecteurDestinationLibelle = true;
    _validSecteurDestinationCode = true;
...
public editWithShowOption(showList: boolean){
     this.courseService.edit().subscribe(course=>{
     const myIndex = this.courses.findIndex(e => e.id === this.selectedCourse.id);
     this.courses[myIndex] = course;
