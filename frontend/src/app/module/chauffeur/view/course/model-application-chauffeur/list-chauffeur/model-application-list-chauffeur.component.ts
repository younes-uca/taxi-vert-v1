...
@Component({
  selector: 'app-model-application-list-chauffeur',
  templateUrl: './model-application-list-chauffeur.component.html',
  styleUrls: ['./model-application-list-chauffeur.component.css']
})
export class ModelApplicationListChauffeurComponent implements OnInit {
   // declarations
