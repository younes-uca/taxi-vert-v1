...
@Component({
  selector: 'app-model-application-view-chauffeur',
  templateUrl: './model-application-view-chauffeur.component.html',
  styleUrls: ['./model-application-view-chauffeur.component.css']
})
export class ModelApplicationViewChauffeurComponent implements OnInit {
