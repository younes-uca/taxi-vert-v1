...
@Component({
  selector: 'app-black-list-chauffeur-view-chauffeur',
  templateUrl: './black-list-chauffeur-view-chauffeur.component.html',
  styleUrls: ['./black-list-chauffeur-view-chauffeur.component.css']
})
export class BlackListChauffeurViewChauffeurComponent implements OnInit {
