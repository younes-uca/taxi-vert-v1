...
@Component({
  selector: 'app-black-list-chauffeur-list-chauffeur',
  templateUrl: './black-list-chauffeur-list-chauffeur.component.html',
  styleUrls: ['./black-list-chauffeur-list-chauffeur.component.css']
})
export class BlackListChauffeurListChauffeurComponent implements OnInit {
   // declarations
