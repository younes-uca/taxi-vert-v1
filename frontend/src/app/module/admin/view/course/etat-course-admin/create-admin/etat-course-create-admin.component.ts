...
@Component({
  selector: 'app-etat-course-create-admin',
  templateUrl: './etat-course-create-admin.component.html',
  styleUrls: ['./etat-course-create-admin.component.css']
})
export class EtatCourseCreateAdminComponent implements OnInit {
