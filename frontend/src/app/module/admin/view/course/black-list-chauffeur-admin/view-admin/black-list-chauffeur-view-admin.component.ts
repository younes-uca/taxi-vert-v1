...
@Component({
  selector: 'app-black-list-chauffeur-view-admin',
  templateUrl: './black-list-chauffeur-view-admin.component.html',
  styleUrls: ['./black-list-chauffeur-view-admin.component.css']
})
export class BlackListChauffeurViewAdminComponent implements OnInit {
