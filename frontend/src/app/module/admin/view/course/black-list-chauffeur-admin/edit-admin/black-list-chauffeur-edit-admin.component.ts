...
@Component({
  selector: 'app-black-list-chauffeur-edit-admin',
  templateUrl: './black-list-chauffeur-edit-admin.component.html',
  styleUrls: ['./black-list-chauffeur-edit-admin.component.css']
})
export class BlackListChauffeurEditAdminComponent implements OnInit {
