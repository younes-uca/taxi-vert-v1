...
@Component({
  selector: 'app-moyen-transport-create-admin',
  templateUrl: './moyen-transport-create-admin.component.html',
  styleUrls: ['./moyen-transport-create-admin.component.css']
})
export class MoyenTransportCreateAdminComponent implements OnInit {
