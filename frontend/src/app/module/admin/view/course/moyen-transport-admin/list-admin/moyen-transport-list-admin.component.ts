...
@Component({
  selector: 'app-moyen-transport-list-admin',
  templateUrl: './moyen-transport-list-admin.component.html',
  styleUrls: ['./moyen-transport-list-admin.component.css']
})
export class MoyenTransportListAdminComponent implements OnInit {
   // declarations
