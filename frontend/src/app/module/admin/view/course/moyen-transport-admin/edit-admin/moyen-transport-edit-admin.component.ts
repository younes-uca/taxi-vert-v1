...
@Component({
  selector: 'app-moyen-transport-edit-admin',
  templateUrl: './moyen-transport-edit-admin.component.html',
  styleUrls: ['./moyen-transport-edit-admin.component.css']
})
export class MoyenTransportEditAdminComponent implements OnInit {
