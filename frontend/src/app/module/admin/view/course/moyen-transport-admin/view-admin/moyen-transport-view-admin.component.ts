...
@Component({
  selector: 'app-moyen-transport-view-admin',
  templateUrl: './moyen-transport-view-admin.component.html',
  styleUrls: ['./moyen-transport-view-admin.component.css']
})
export class MoyenTransportViewAdminComponent implements OnInit {
