...
@Component({
  selector: 'app-course-edit-admin',
  templateUrl: './course-edit-admin.component.html',
  styleUrls: ['./course-edit-admin.component.css']
})
export class CourseEditAdminComponent implements OnInit {
