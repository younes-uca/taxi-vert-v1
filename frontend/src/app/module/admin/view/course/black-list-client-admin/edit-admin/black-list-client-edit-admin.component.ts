...
@Component({
  selector: 'app-black-list-client-edit-admin',
  templateUrl: './black-list-client-edit-admin.component.html',
  styleUrls: ['./black-list-client-edit-admin.component.css']
})
export class BlackListClientEditAdminComponent implements OnInit {
