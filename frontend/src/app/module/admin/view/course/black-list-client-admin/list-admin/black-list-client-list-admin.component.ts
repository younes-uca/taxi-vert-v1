...
@Component({
  selector: 'app-black-list-client-list-admin',
  templateUrl: './black-list-client-list-admin.component.html',
  styleUrls: ['./black-list-client-list-admin.component.css']
})
export class BlackListClientListAdminComponent implements OnInit {
   // declarations
