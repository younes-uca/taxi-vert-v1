...
@Component({
  selector: 'app-marque-voiture-edit-admin',
  templateUrl: './marque-voiture-edit-admin.component.html',
  styleUrls: ['./marque-voiture-edit-admin.component.css']
})
export class MarqueVoitureEditAdminComponent implements OnInit {
