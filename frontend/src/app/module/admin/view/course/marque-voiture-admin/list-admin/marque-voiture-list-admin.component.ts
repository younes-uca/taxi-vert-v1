...
@Component({
  selector: 'app-marque-voiture-list-admin',
  templateUrl: './marque-voiture-list-admin.component.html',
  styleUrls: ['./marque-voiture-list-admin.component.css']
})
export class MarqueVoitureListAdminComponent implements OnInit {
   // declarations
