...
@Component({
  selector: 'app-marque-voiture-create-admin',
  templateUrl: './marque-voiture-create-admin.component.html',
  styleUrls: ['./marque-voiture-create-admin.component.css']
})
export class MarqueVoitureCreateAdminComponent implements OnInit {
