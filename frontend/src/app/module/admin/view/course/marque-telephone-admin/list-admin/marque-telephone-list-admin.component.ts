...
@Component({
  selector: 'app-marque-telephone-list-admin',
  templateUrl: './marque-telephone-list-admin.component.html',
  styleUrls: ['./marque-telephone-list-admin.component.css']
})
export class MarqueTelephoneListAdminComponent implements OnInit {
   // declarations
