...
@Component({
  selector: 'app-marque-telephone-view-admin',
  templateUrl: './marque-telephone-view-admin.component.html',
  styleUrls: ['./marque-telephone-view-admin.component.css']
})
export class MarqueTelephoneViewAdminComponent implements OnInit {
