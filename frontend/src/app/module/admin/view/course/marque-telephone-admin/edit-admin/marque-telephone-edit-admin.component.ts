...
@Component({
  selector: 'app-marque-telephone-edit-admin',
  templateUrl: './marque-telephone-edit-admin.component.html',
  styleUrls: ['./marque-telephone-edit-admin.component.css']
})
export class MarqueTelephoneEditAdminComponent implements OnInit {
