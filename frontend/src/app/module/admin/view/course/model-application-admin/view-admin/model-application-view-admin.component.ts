...
@Component({
  selector: 'app-model-application-view-admin',
  templateUrl: './model-application-view-admin.component.html',
  styleUrls: ['./model-application-view-admin.component.css']
})
export class ModelApplicationViewAdminComponent implements OnInit {
