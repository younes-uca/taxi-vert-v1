...
@Component({
  selector: 'app-secteur-create-admin',
  templateUrl: './secteur-create-admin.component.html',
  styleUrls: ['./secteur-create-admin.component.css']
})
export class SecteurCreateAdminComponent implements OnInit {
