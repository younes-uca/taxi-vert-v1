...
@Component({
  selector: 'app-theme-list-admin',
  templateUrl: './theme-list-admin.component.html',
  styleUrls: ['./theme-list-admin.component.css']
})
export class ThemeListAdminComponent implements OnInit {
   // declarations
