...
@Component({
  selector: 'app-theme-create-admin',
  templateUrl: './theme-create-admin.component.html',
  styleUrls: ['./theme-create-admin.component.css']
})
export class ThemeCreateAdminComponent implements OnInit {
