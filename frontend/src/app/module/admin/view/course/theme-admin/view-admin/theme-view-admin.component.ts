...
@Component({
  selector: 'app-theme-view-admin',
  templateUrl: './theme-view-admin.component.html',
  styleUrls: ['./theme-view-admin.component.css']
})
export class ThemeViewAdminComponent implements OnInit {
