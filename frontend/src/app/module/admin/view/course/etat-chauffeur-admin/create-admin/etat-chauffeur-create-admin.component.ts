...
@Component({
  selector: 'app-etat-chauffeur-create-admin',
  templateUrl: './etat-chauffeur-create-admin.component.html',
  styleUrls: ['./etat-chauffeur-create-admin.component.css']
})
export class EtatChauffeurCreateAdminComponent implements OnInit {
