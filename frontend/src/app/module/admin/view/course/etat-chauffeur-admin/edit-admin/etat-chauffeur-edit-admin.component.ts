...
@Component({
  selector: 'app-etat-chauffeur-edit-admin',
  templateUrl: './etat-chauffeur-edit-admin.component.html',
  styleUrls: ['./etat-chauffeur-edit-admin.component.css']
})
export class EtatChauffeurEditAdminComponent implements OnInit {
