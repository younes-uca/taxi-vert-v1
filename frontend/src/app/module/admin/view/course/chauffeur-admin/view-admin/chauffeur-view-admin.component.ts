...
@Component({
  selector: 'app-chauffeur-view-admin',
  templateUrl: './chauffeur-view-admin.component.html',
  styleUrls: ['./chauffeur-view-admin.component.css']
})
export class ChauffeurViewAdminComponent implements OnInit {
