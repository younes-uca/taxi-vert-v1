...
@Component({
  selector: 'app-chauffeur-list-admin',
  templateUrl: './chauffeur-list-admin.component.html',
  styleUrls: ['./chauffeur-list-admin.component.css']
})
export class ChauffeurListAdminComponent implements OnInit {
   // declarations
