...
@Component({
  selector: 'app-ville-view-client',
  templateUrl: './ville-view-client.component.html',
  styleUrls: ['./ville-view-client.component.css']
})
export class VilleViewClientComponent implements OnInit {
