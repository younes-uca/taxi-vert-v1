...
@Component({
  selector: 'app-ville-edit-client',
  templateUrl: './ville-edit-client.component.html',
  styleUrls: ['./ville-edit-client.component.css']
})
export class VilleEditClientComponent implements OnInit {
