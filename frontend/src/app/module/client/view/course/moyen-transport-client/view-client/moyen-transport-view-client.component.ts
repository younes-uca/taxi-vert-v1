...
@Component({
  selector: 'app-moyen-transport-view-client',
  templateUrl: './moyen-transport-view-client.component.html',
  styleUrls: ['./moyen-transport-view-client.component.css']
})
export class MoyenTransportViewClientComponent implements OnInit {
