...
@Component({
  selector: 'app-moyen-transport-list-client',
  templateUrl: './moyen-transport-list-client.component.html',
  styleUrls: ['./moyen-transport-list-client.component.css']
})
export class MoyenTransportListClientComponent implements OnInit {
   // declarations
