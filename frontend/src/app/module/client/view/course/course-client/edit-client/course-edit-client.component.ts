...
@Component({
  selector: 'app-course-edit-client',
  templateUrl: './course-edit-client.component.html',
  styleUrls: ['./course-edit-client.component.css']
})
export class CourseEditClientComponent implements OnInit {
