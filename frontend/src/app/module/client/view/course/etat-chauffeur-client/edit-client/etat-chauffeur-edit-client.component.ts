...
@Component({
  selector: 'app-etat-chauffeur-edit-client',
  templateUrl: './etat-chauffeur-edit-client.component.html',
  styleUrls: ['./etat-chauffeur-edit-client.component.css']
})
export class EtatChauffeurEditClientComponent implements OnInit {
