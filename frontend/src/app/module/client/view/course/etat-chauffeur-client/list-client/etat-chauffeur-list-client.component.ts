...
@Component({
  selector: 'app-etat-chauffeur-list-client',
  templateUrl: './etat-chauffeur-list-client.component.html',
  styleUrls: ['./etat-chauffeur-list-client.component.css']
})
export class EtatChauffeurListClientComponent implements OnInit {
   // declarations
