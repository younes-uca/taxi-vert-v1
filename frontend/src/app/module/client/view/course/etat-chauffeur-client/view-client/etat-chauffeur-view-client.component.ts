...
@Component({
  selector: 'app-etat-chauffeur-view-client',
  templateUrl: './etat-chauffeur-view-client.component.html',
  styleUrls: ['./etat-chauffeur-view-client.component.css']
})
export class EtatChauffeurViewClientComponent implements OnInit {
