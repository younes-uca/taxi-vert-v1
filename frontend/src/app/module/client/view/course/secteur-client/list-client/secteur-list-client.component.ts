...
@Component({
  selector: 'app-secteur-list-client',
  templateUrl: './secteur-list-client.component.html',
  styleUrls: ['./secteur-list-client.component.css']
})
export class SecteurListClientComponent implements OnInit {
   // declarations
