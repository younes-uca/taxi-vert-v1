...
@Component({
  selector: 'app-secteur-edit-client',
  templateUrl: './secteur-edit-client.component.html',
  styleUrls: ['./secteur-edit-client.component.css']
})
export class SecteurEditClientComponent implements OnInit {
