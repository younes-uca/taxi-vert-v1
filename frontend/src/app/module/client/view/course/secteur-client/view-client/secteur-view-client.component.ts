...
@Component({
  selector: 'app-secteur-view-client',
  templateUrl: './secteur-view-client.component.html',
  styleUrls: ['./secteur-view-client.component.css']
})
export class SecteurViewClientComponent implements OnInit {
