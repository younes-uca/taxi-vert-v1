...
@Component({
  selector: 'app-black-list-client-view-client',
  templateUrl: './black-list-client-view-client.component.html',
  styleUrls: ['./black-list-client-view-client.component.css']
})
export class BlackListClientViewClientComponent implements OnInit {
