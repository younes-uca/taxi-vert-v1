...
@Component({
  selector: 'app-black-list-client-list-client',
  templateUrl: './black-list-client-list-client.component.html',
  styleUrls: ['./black-list-client-list-client.component.css']
})
export class BlackListClientListClientComponent implements OnInit {
   // declarations
