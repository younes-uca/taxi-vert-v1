...
@Component({
  selector: 'app-black-list-client-edit-client',
  templateUrl: './black-list-client-edit-client.component.html',
  styleUrls: ['./black-list-client-edit-client.component.css']
})
export class BlackListClientEditClientComponent implements OnInit {
