...
@Component({
  selector: 'app-marque-telephone-edit-client',
  templateUrl: './marque-telephone-edit-client.component.html',
  styleUrls: ['./marque-telephone-edit-client.component.css']
})
export class MarqueTelephoneEditClientComponent implements OnInit {
