...
@Component({
  selector: 'app-marque-telephone-create-client',
  templateUrl: './marque-telephone-create-client.component.html',
  styleUrls: ['./marque-telephone-create-client.component.css']
})
export class MarqueTelephoneCreateClientComponent implements OnInit {
