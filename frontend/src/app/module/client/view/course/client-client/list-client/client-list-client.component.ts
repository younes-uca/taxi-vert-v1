...
@Component({
  selector: 'app-client-list-client',
  templateUrl: './client-list-client.component.html',
  styleUrls: ['./client-list-client.component.css']
})
export class ClientListClientComponent implements OnInit {
   // declarations
