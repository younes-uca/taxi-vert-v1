...
@Component({
  selector: 'app-client-view-client',
  templateUrl: './client-view-client.component.html',
  styleUrls: ['./client-view-client.component.css']
})
export class ClientViewClientComponent implements OnInit {
