...
@Component({
  selector: 'app-langue-list-client',
  templateUrl: './langue-list-client.component.html',
  styleUrls: ['./langue-list-client.component.css']
})
export class LangueListClientComponent implements OnInit {
   // declarations
