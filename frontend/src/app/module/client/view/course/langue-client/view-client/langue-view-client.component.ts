...
@Component({
  selector: 'app-langue-view-client',
  templateUrl: './langue-view-client.component.html',
  styleUrls: ['./langue-view-client.component.css']
})
export class LangueViewClientComponent implements OnInit {
