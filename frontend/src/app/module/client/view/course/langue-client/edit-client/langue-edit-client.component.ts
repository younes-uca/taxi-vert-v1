...
@Component({
  selector: 'app-langue-edit-client',
  templateUrl: './langue-edit-client.component.html',
  styleUrls: ['./langue-edit-client.component.css']
})
export class LangueEditClientComponent implements OnInit {
