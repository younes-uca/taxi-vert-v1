...
@Component({
  selector: 'app-marque-voiture-view-client',
  templateUrl: './marque-voiture-view-client.component.html',
  styleUrls: ['./marque-voiture-view-client.component.css']
})
export class MarqueVoitureViewClientComponent implements OnInit {
