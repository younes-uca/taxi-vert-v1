...
@Component({
  selector: 'app-marque-voiture-edit-client',
  templateUrl: './marque-voiture-edit-client.component.html',
  styleUrls: ['./marque-voiture-edit-client.component.css']
})
export class MarqueVoitureEditClientComponent implements OnInit {
