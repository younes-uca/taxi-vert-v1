...
@Component({
  selector: 'app-etat-course-create-client',
  templateUrl: './etat-course-create-client.component.html',
  styleUrls: ['./etat-course-create-client.component.css']
})
export class EtatCourseCreateClientComponent implements OnInit {
