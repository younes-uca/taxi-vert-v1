...
@Component({
  selector: 'app-etat-course-edit-client',
  templateUrl: './etat-course-edit-client.component.html',
  styleUrls: ['./etat-course-edit-client.component.css']
})
export class EtatCourseEditClientComponent implements OnInit {
