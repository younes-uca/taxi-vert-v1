...
@Component({
  selector: 'app-etat-course-view-client',
  templateUrl: './etat-course-view-client.component.html',
  styleUrls: ['./etat-course-view-client.component.css']
})
export class EtatCourseViewClientComponent implements OnInit {
