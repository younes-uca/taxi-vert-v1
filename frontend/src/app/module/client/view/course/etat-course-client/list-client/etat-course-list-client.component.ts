...
@Component({
  selector: 'app-etat-course-list-client',
  templateUrl: './etat-course-list-client.component.html',
  styleUrls: ['./etat-course-list-client.component.css']
})
export class EtatCourseListClientComponent implements OnInit {
   // declarations
