...
@Component({
  selector: 'app-operateur-list-client',
  templateUrl: './operateur-list-client.component.html',
  styleUrls: ['./operateur-list-client.component.css']
})
export class OperateurListClientComponent implements OnInit {
   // declarations
