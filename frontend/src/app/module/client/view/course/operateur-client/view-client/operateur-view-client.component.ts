...
@Component({
  selector: 'app-operateur-view-client',
  templateUrl: './operateur-view-client.component.html',
  styleUrls: ['./operateur-view-client.component.css']
})
export class OperateurViewClientComponent implements OnInit {
