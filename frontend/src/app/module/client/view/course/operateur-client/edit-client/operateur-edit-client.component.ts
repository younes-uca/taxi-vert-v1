...
@Component({
  selector: 'app-operateur-edit-client',
  templateUrl: './operateur-edit-client.component.html',
  styleUrls: ['./operateur-edit-client.component.css']
})
export class OperateurEditClientComponent implements OnInit {
