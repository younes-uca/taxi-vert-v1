...
@Component({
  selector: 'app-black-list-chauffeur-list-client',
  templateUrl: './black-list-chauffeur-list-client.component.html',
  styleUrls: ['./black-list-chauffeur-list-client.component.css']
})
export class BlackListChauffeurListClientComponent implements OnInit {
   // declarations
