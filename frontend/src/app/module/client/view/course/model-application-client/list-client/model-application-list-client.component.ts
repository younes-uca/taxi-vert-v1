...
@Component({
  selector: 'app-model-application-list-client',
  templateUrl: './model-application-list-client.component.html',
  styleUrls: ['./model-application-list-client.component.css']
})
export class ModelApplicationListClientComponent implements OnInit {
   // declarations
