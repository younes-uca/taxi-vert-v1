...
@Component({
  selector: 'app-model-application-view-client',
  templateUrl: './model-application-view-client.component.html',
  styleUrls: ['./model-application-view-client.component.css']
})
export class ModelApplicationViewClientComponent implements OnInit {
