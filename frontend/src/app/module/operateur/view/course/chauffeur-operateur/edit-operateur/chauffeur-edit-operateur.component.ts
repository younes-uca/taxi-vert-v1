...
@Component({
  selector: 'app-chauffeur-edit-operateur',
  templateUrl: './chauffeur-edit-operateur.component.html',
  styleUrls: ['./chauffeur-edit-operateur.component.css']
})
export class ChauffeurEditOperateurComponent implements OnInit {
