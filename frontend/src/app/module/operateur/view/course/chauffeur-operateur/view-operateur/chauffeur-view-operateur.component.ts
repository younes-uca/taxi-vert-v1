...
@Component({
  selector: 'app-chauffeur-view-operateur',
  templateUrl: './chauffeur-view-operateur.component.html',
  styleUrls: ['./chauffeur-view-operateur.component.css']
})
export class ChauffeurViewOperateurComponent implements OnInit {
