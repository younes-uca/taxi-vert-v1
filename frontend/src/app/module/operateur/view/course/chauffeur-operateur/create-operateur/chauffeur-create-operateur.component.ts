...
@Component({
  selector: 'app-chauffeur-create-operateur',
  templateUrl: './chauffeur-create-operateur.component.html',
  styleUrls: ['./chauffeur-create-operateur.component.css']
})
export class ChauffeurCreateOperateurComponent implements OnInit {
