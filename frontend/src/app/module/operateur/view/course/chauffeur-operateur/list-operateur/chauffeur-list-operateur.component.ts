...
@Component({
  selector: 'app-chauffeur-list-operateur',
  templateUrl: './chauffeur-list-operateur.component.html',
  styleUrls: ['./chauffeur-list-operateur.component.css']
})
export class ChauffeurListOperateurComponent implements OnInit {
   // declarations
