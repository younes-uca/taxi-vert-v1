...
@Component({
  selector: 'app-course-view-operateur',
  templateUrl: './course-view-operateur.component.html',
  styleUrls: ['./course-view-operateur.component.css']
})
export class CourseViewOperateurComponent implements OnInit {
