...
@Component({
  selector: 'app-course-list-operateur',
  templateUrl: './course-list-operateur.component.html',
  styleUrls: ['./course-list-operateur.component.css']
})
export class CourseListOperateurComponent implements OnInit {
   // declarations
