...
@Component({
  selector: 'app-course-edit-operateur',
  templateUrl: './course-edit-operateur.component.html',
  styleUrls: ['./course-edit-operateur.component.css']
})
export class CourseEditOperateurComponent implements OnInit {
