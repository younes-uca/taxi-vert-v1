...
@Component({
  selector: 'app-course-create-operateur',
  templateUrl: './course-create-operateur.component.html',
  styleUrls: ['./course-create-operateur.component.css']
})
export class CourseCreateOperateurComponent implements OnInit {
