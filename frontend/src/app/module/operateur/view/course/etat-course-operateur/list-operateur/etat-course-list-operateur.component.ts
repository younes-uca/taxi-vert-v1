...
@Component({
  selector: 'app-etat-course-list-operateur',
  templateUrl: './etat-course-list-operateur.component.html',
  styleUrls: ['./etat-course-list-operateur.component.css']
})
export class EtatCourseListOperateurComponent implements OnInit {
   // declarations
