...
@Component({
  selector: 'app-etat-course-view-operateur',
  templateUrl: './etat-course-view-operateur.component.html',
  styleUrls: ['./etat-course-view-operateur.component.css']
})
export class EtatCourseViewOperateurComponent implements OnInit {
