...
@Component({
  selector: 'app-etat-course-create-operateur',
  templateUrl: './etat-course-create-operateur.component.html',
  styleUrls: ['./etat-course-create-operateur.component.css']
})
export class EtatCourseCreateOperateurComponent implements OnInit {
