...
@Component({
  selector: 'app-etat-course-edit-operateur',
  templateUrl: './etat-course-edit-operateur.component.html',
  styleUrls: ['./etat-course-edit-operateur.component.css']
})
export class EtatCourseEditOperateurComponent implements OnInit {
