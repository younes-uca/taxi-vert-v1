...
@Component({
  selector: 'app-ville-view-operateur',
  templateUrl: './ville-view-operateur.component.html',
  styleUrls: ['./ville-view-operateur.component.css']
})
export class VilleViewOperateurComponent implements OnInit {
