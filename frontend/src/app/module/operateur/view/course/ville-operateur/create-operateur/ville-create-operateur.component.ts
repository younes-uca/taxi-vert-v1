...
@Component({
  selector: 'app-ville-create-operateur',
  templateUrl: './ville-create-operateur.component.html',
  styleUrls: ['./ville-create-operateur.component.css']
})
export class VilleCreateOperateurComponent implements OnInit {
