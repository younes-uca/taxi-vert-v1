...
@Component({
  selector: 'app-ville-list-operateur',
  templateUrl: './ville-list-operateur.component.html',
  styleUrls: ['./ville-list-operateur.component.css']
})
export class VilleListOperateurComponent implements OnInit {
   // declarations
