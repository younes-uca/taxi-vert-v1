...
@Component({
  selector: 'app-model-application-create-operateur',
  templateUrl: './model-application-create-operateur.component.html',
  styleUrls: ['./model-application-create-operateur.component.css']
})
export class ModelApplicationCreateOperateurComponent implements OnInit {
