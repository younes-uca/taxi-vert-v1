...
@Component({
  selector: 'app-model-application-list-operateur',
  templateUrl: './model-application-list-operateur.component.html',
  styleUrls: ['./model-application-list-operateur.component.css']
})
export class ModelApplicationListOperateurComponent implements OnInit {
   // declarations
