...
@Component({
  selector: 'app-model-application-edit-operateur',
  templateUrl: './model-application-edit-operateur.component.html',
  styleUrls: ['./model-application-edit-operateur.component.css']
})
export class ModelApplicationEditOperateurComponent implements OnInit {
