...
@Component({
  selector: 'app-marque-telephone-view-operateur',
  templateUrl: './marque-telephone-view-operateur.component.html',
  styleUrls: ['./marque-telephone-view-operateur.component.css']
})
export class MarqueTelephoneViewOperateurComponent implements OnInit {
