...
@Component({
  selector: 'app-marque-telephone-list-operateur',
  templateUrl: './marque-telephone-list-operateur.component.html',
  styleUrls: ['./marque-telephone-list-operateur.component.css']
})
export class MarqueTelephoneListOperateurComponent implements OnInit {
   // declarations
