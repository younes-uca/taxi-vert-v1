...
@Component({
  selector: 'app-marque-telephone-create-operateur',
  templateUrl: './marque-telephone-create-operateur.component.html',
  styleUrls: ['./marque-telephone-create-operateur.component.css']
})
export class MarqueTelephoneCreateOperateurComponent implements OnInit {
