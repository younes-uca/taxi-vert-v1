...
@Component({
  selector: 'app-etat-chauffeur-view-operateur',
  templateUrl: './etat-chauffeur-view-operateur.component.html',
  styleUrls: ['./etat-chauffeur-view-operateur.component.css']
})
export class EtatChauffeurViewOperateurComponent implements OnInit {
