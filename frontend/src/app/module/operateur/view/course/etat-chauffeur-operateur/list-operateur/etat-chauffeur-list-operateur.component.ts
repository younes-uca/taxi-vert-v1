...
@Component({
  selector: 'app-etat-chauffeur-list-operateur',
  templateUrl: './etat-chauffeur-list-operateur.component.html',
  styleUrls: ['./etat-chauffeur-list-operateur.component.css']
})
export class EtatChauffeurListOperateurComponent implements OnInit {
   // declarations
