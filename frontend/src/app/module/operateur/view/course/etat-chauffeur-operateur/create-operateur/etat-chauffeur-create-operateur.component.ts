...
@Component({
  selector: 'app-etat-chauffeur-create-operateur',
  templateUrl: './etat-chauffeur-create-operateur.component.html',
  styleUrls: ['./etat-chauffeur-create-operateur.component.css']
})
export class EtatChauffeurCreateOperateurComponent implements OnInit {
