...
@Component({
  selector: 'app-langue-edit-operateur',
  templateUrl: './langue-edit-operateur.component.html',
  styleUrls: ['./langue-edit-operateur.component.css']
})
export class LangueEditOperateurComponent implements OnInit {
