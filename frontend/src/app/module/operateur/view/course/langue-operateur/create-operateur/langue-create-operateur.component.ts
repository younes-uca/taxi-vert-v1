...
@Component({
  selector: 'app-langue-create-operateur',
  templateUrl: './langue-create-operateur.component.html',
  styleUrls: ['./langue-create-operateur.component.css']
})
export class LangueCreateOperateurComponent implements OnInit {
