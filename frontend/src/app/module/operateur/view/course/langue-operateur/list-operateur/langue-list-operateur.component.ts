...
@Component({
  selector: 'app-langue-list-operateur',
  templateUrl: './langue-list-operateur.component.html',
  styleUrls: ['./langue-list-operateur.component.css']
})
export class LangueListOperateurComponent implements OnInit {
   // declarations
