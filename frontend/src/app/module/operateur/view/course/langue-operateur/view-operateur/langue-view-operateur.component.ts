...
@Component({
  selector: 'app-langue-view-operateur',
  templateUrl: './langue-view-operateur.component.html',
  styleUrls: ['./langue-view-operateur.component.css']
})
export class LangueViewOperateurComponent implements OnInit {
