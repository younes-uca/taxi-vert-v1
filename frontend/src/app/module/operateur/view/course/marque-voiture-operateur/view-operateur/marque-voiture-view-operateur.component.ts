...
@Component({
  selector: 'app-marque-voiture-view-operateur',
  templateUrl: './marque-voiture-view-operateur.component.html',
  styleUrls: ['./marque-voiture-view-operateur.component.css']
})
export class MarqueVoitureViewOperateurComponent implements OnInit {
