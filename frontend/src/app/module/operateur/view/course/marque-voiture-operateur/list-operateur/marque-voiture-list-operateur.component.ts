...
@Component({
  selector: 'app-marque-voiture-list-operateur',
  templateUrl: './marque-voiture-list-operateur.component.html',
  styleUrls: ['./marque-voiture-list-operateur.component.css']
})
export class MarqueVoitureListOperateurComponent implements OnInit {
   // declarations
