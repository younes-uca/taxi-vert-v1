...
@Component({
  selector: 'app-marque-voiture-create-operateur',
  templateUrl: './marque-voiture-create-operateur.component.html',
  styleUrls: ['./marque-voiture-create-operateur.component.css']
})
export class MarqueVoitureCreateOperateurComponent implements OnInit {
