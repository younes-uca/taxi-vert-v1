...
@Component({
  selector: 'app-operateur-create-operateur',
  templateUrl: './operateur-create-operateur.component.html',
  styleUrls: ['./operateur-create-operateur.component.css']
})
export class OperateurCreateOperateurComponent implements OnInit {
