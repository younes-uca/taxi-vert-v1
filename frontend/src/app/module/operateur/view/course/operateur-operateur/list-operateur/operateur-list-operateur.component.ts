...
@Component({
  selector: 'app-operateur-list-operateur',
  templateUrl: './operateur-list-operateur.component.html',
  styleUrls: ['./operateur-list-operateur.component.css']
})
export class OperateurListOperateurComponent implements OnInit {
   // declarations
