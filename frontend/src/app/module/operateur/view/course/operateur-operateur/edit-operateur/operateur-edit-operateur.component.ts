...
@Component({
  selector: 'app-operateur-edit-operateur',
  templateUrl: './operateur-edit-operateur.component.html',
  styleUrls: ['./operateur-edit-operateur.component.css']
})
export class OperateurEditOperateurComponent implements OnInit {
