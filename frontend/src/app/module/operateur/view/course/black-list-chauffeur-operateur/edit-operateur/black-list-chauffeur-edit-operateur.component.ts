...
@Component({
  selector: 'app-black-list-chauffeur-edit-operateur',
  templateUrl: './black-list-chauffeur-edit-operateur.component.html',
  styleUrls: ['./black-list-chauffeur-edit-operateur.component.css']
})
export class BlackListChauffeurEditOperateurComponent implements OnInit {
