...
@Component({
  selector: 'app-black-list-chauffeur-list-operateur',
  templateUrl: './black-list-chauffeur-list-operateur.component.html',
  styleUrls: ['./black-list-chauffeur-list-operateur.component.css']
})
export class BlackListChauffeurListOperateurComponent implements OnInit {
   // declarations
