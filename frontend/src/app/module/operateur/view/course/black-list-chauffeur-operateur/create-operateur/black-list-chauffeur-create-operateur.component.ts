...
@Component({
  selector: 'app-black-list-chauffeur-create-operateur',
  templateUrl: './black-list-chauffeur-create-operateur.component.html',
  styleUrls: ['./black-list-chauffeur-create-operateur.component.css']
})
export class BlackListChauffeurCreateOperateurComponent implements OnInit {
