...
@Component({
  selector: 'app-black-list-chauffeur-view-operateur',
  templateUrl: './black-list-chauffeur-view-operateur.component.html',
  styleUrls: ['./black-list-chauffeur-view-operateur.component.css']
})
export class BlackListChauffeurViewOperateurComponent implements OnInit {
