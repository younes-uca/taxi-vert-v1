...
@Component({
  selector: 'app-secteur-view-operateur',
  templateUrl: './secteur-view-operateur.component.html',
  styleUrls: ['./secteur-view-operateur.component.css']
})
export class SecteurViewOperateurComponent implements OnInit {
