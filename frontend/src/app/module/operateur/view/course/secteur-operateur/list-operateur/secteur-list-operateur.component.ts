...
@Component({
  selector: 'app-secteur-list-operateur',
  templateUrl: './secteur-list-operateur.component.html',
  styleUrls: ['./secteur-list-operateur.component.css']
})
export class SecteurListOperateurComponent implements OnInit {
   // declarations
