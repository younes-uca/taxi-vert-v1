...
@Component({
  selector: 'app-black-list-client-list-operateur',
  templateUrl: './black-list-client-list-operateur.component.html',
  styleUrls: ['./black-list-client-list-operateur.component.css']
})
export class BlackListClientListOperateurComponent implements OnInit {
   // declarations
