...
@Component({
  selector: 'app-black-list-client-edit-operateur',
  templateUrl: './black-list-client-edit-operateur.component.html',
  styleUrls: ['./black-list-client-edit-operateur.component.css']
})
export class BlackListClientEditOperateurComponent implements OnInit {
