...
@Component({
  selector: 'app-black-list-client-create-operateur',
  templateUrl: './black-list-client-create-operateur.component.html',
  styleUrls: ['./black-list-client-create-operateur.component.css']
})
export class BlackListClientCreateOperateurComponent implements OnInit {
