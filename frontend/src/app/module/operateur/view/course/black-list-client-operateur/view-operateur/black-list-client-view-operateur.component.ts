...
@Component({
  selector: 'app-black-list-client-view-operateur',
  templateUrl: './black-list-client-view-operateur.component.html',
  styleUrls: ['./black-list-client-view-operateur.component.css']
})
export class BlackListClientViewOperateurComponent implements OnInit {
