...
@Component({
  selector: 'app-theme-view-operateur',
  templateUrl: './theme-view-operateur.component.html',
  styleUrls: ['./theme-view-operateur.component.css']
})
export class ThemeViewOperateurComponent implements OnInit {
