...
@Component({
  selector: 'app-theme-list-operateur',
  templateUrl: './theme-list-operateur.component.html',
  styleUrls: ['./theme-list-operateur.component.css']
})
export class ThemeListOperateurComponent implements OnInit {
   // declarations
