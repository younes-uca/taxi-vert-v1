...
@Component({
  selector: 'app-theme-edit-operateur',
  templateUrl: './theme-edit-operateur.component.html',
  styleUrls: ['./theme-edit-operateur.component.css']
})
export class ThemeEditOperateurComponent implements OnInit {
