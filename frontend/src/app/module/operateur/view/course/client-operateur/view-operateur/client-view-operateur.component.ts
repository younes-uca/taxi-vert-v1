...
@Component({
  selector: 'app-client-view-operateur',
  templateUrl: './client-view-operateur.component.html',
  styleUrls: ['./client-view-operateur.component.css']
})
export class ClientViewOperateurComponent implements OnInit {
