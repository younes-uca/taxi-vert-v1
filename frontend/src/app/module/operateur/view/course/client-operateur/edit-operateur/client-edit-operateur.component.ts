...
@Component({
  selector: 'app-client-edit-operateur',
  templateUrl: './client-edit-operateur.component.html',
  styleUrls: ['./client-edit-operateur.component.css']
})
export class ClientEditOperateurComponent implements OnInit {
