...
@Component({
  selector: 'app-moyen-transport-list-operateur',
  templateUrl: './moyen-transport-list-operateur.component.html',
  styleUrls: ['./moyen-transport-list-operateur.component.css']
})
export class MoyenTransportListOperateurComponent implements OnInit {
   // declarations
