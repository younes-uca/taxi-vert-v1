...
@Component({
  selector: 'app-moyen-transport-create-operateur',
  templateUrl: './moyen-transport-create-operateur.component.html',
  styleUrls: ['./moyen-transport-create-operateur.component.css']
})
export class MoyenTransportCreateOperateurComponent implements OnInit {
