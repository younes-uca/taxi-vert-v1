...
@Component({
  selector: 'app-moyen-transport-view-operateur',
  templateUrl: './moyen-transport-view-operateur.component.html',
  styleUrls: ['./moyen-transport-view-operateur.component.css']
})
export class MoyenTransportViewOperateurComponent implements OnInit {
