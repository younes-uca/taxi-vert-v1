...
@Component({
  selector: 'app-moyen-transport-edit-operateur',
  templateUrl: './moyen-transport-edit-operateur.component.html',
  styleUrls: ['./moyen-transport-edit-operateur.component.css']
})
export class MoyenTransportEditOperateurComponent implements OnInit {
