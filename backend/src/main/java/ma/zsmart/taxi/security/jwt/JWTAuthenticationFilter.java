package ma.zsmart.taxi.security.jwt;
...
import ma.zsmart.taxi.TaxiApplication;
import ma.zsmart.taxi.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = TaxiApplication.getCtx().getBean(UserService.class);
