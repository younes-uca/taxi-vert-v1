...
@RestController
@RequestMapping("/api/chauffeur/client")
public class ClientRestChauffeur  extends AbstractController<Client, ClientDto, ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientChauffeurService, ClientConverter> {
...
//    }
    ...
    public ClientRestChauffeur (ClientChauffeurService service, ClientConverter converter) {
