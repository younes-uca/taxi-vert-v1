...
public class ClientRestClient  extends AbstractController<Client, ClientDto, ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientClientService, ClientConverter> {
