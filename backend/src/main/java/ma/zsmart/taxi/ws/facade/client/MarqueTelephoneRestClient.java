...
@RestController
@RequestMapping("/api/client/marqueTelephone")
public class MarqueTelephoneRestClient  extends AbstractController<MarqueTelephone, MarqueTelephoneDto, MarqueTelephoneHistory, MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria, MarqueTelephoneClientService, MarqueTelephoneConverter> {
...
//    }
    ...
    public MarqueTelephoneRestClient (MarqueTelephoneClientService service, MarqueTelephoneConverter converter) {
