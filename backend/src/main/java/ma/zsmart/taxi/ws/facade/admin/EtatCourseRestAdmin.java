...
@RestController
@RequestMapping("/api/admin/etatCourse")
public class EtatCourseRestAdmin  extends AbstractController<EtatCourse, EtatCourseDto, EtatCourseHistory, EtatCourseCriteria, EtatCourseHistoryCriteria, EtatCourseAdminService, EtatCourseConverter> {
...
//    }
    ...
    public EtatCourseRestAdmin (EtatCourseAdminService service, EtatCourseConverter converter) {
