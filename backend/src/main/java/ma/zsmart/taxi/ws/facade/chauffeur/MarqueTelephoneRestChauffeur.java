...
@RestController
@RequestMapping("/api/chauffeur/marqueTelephone")
public class MarqueTelephoneRestChauffeur  extends AbstractController<MarqueTelephone, MarqueTelephoneDto, MarqueTelephoneHistory, MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria, MarqueTelephoneChauffeurService, MarqueTelephoneConverter> {
...
//    }
    ...
    public MarqueTelephoneRestChauffeur (MarqueTelephoneChauffeurService service, MarqueTelephoneConverter converter) {
