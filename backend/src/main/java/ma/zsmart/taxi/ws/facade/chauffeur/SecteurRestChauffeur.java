...
@RestController
@RequestMapping("/api/chauffeur/secteur")
public class SecteurRestChauffeur  extends AbstractController<Secteur, SecteurDto, SecteurHistory, SecteurCriteria, SecteurHistoryCriteria, SecteurChauffeurService, SecteurConverter> {
...
//    }
    ...
    public SecteurRestChauffeur (SecteurChauffeurService service, SecteurConverter converter) {
