...
@RestController
@RequestMapping("/api/admin/marqueTelephone")
public class MarqueTelephoneRestAdmin  extends AbstractController<MarqueTelephone, MarqueTelephoneDto, MarqueTelephoneHistory, MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria, MarqueTelephoneAdminService, MarqueTelephoneConverter> {
...
//    }
    ...
    public MarqueTelephoneRestAdmin (MarqueTelephoneAdminService service, MarqueTelephoneConverter converter) {
