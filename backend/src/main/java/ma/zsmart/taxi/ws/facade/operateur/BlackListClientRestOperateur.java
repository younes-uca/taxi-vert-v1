...
@RestController
@RequestMapping("/api/operateur/blackListClient")
public class BlackListClientRestOperateur  extends AbstractController<BlackListClient, BlackListClientDto, BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientOperateurService, BlackListClientConverter> {
...
//    }
    ...
    public BlackListClientRestOperateur (BlackListClientOperateurService service, BlackListClientConverter converter) {
