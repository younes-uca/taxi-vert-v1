...
@RestController
@RequestMapping("/api/operateur/client")
public class ClientRestOperateur  extends AbstractController<Client, ClientDto, ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientOperateurService, ClientConverter> {
...
//    }
    ...
    public ClientRestOperateur (ClientOperateurService service, ClientConverter converter) {
