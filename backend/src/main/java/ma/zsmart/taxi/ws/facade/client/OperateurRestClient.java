...
@RestController
@RequestMapping("/api/client/operateur")
public class OperateurRestClient  extends AbstractController<Operateur, OperateurDto, OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurClientService, OperateurConverter> {
...
//    }
    ...
    public OperateurRestClient (OperateurClientService service, OperateurConverter converter) {
