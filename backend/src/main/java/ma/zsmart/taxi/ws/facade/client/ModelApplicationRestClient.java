...
@RestController
@RequestMapping("/api/client/modelApplication")
public class ModelApplicationRestClient  extends AbstractController<ModelApplication, ModelApplicationDto, ModelApplicationHistory, ModelApplicationCriteria, ModelApplicationHistoryCriteria, ModelApplicationClientService, ModelApplicationConverter> {
...
//    }
    ...
    public ModelApplicationRestClient (ModelApplicationClientService service, ModelApplicationConverter converter) {
