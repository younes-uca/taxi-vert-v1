...
@RestController
@RequestMapping("/api/chauffeur/ville")
public class VilleRestChauffeur  extends AbstractController<Ville, VilleDto, VilleHistory, VilleCriteria, VilleHistoryCriteria, VilleChauffeurService, VilleConverter> {
...
//    }
    ...
    public VilleRestChauffeur (VilleChauffeurService service, VilleConverter converter) {
