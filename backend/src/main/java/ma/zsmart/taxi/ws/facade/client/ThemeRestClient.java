...
@RestController
@RequestMapping("/api/client/theme")
public class ThemeRestClient  extends AbstractController<Theme, ThemeDto, ThemeHistory, ThemeCriteria, ThemeHistoryCriteria, ThemeClientService, ThemeConverter> {
...
//    }
    ...
    public ThemeRestClient (ThemeClientService service, ThemeConverter converter) {
