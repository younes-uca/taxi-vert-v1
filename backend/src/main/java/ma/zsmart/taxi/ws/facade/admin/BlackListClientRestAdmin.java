...
@RestController
@RequestMapping("/api/admin/blackListClient")
public class BlackListClientRestAdmin  extends AbstractController<BlackListClient, BlackListClientDto, BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientAdminService, BlackListClientConverter> {
...
//    }
    ...
    public BlackListClientRestAdmin (BlackListClientAdminService service, BlackListClientConverter converter) {
