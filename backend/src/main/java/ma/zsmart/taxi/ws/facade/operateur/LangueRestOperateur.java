...
@RestController
@RequestMapping("/api/operateur/langue")
public class LangueRestOperateur  extends AbstractController<Langue, LangueDto, LangueHistory, LangueCriteria, LangueHistoryCriteria, LangueOperateurService, LangueConverter> {
...
//    }
    ...
    public LangueRestOperateur (LangueOperateurService service, LangueConverter converter) {
