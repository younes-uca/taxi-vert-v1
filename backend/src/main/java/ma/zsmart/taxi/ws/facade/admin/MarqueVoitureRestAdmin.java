...
@RestController
@RequestMapping("/api/admin/marqueVoiture")
public class MarqueVoitureRestAdmin  extends AbstractController<MarqueVoiture, MarqueVoitureDto, MarqueVoitureHistory, MarqueVoitureCriteria, MarqueVoitureHistoryCriteria, MarqueVoitureAdminService, MarqueVoitureConverter> {
...
//    }
    ...
    public MarqueVoitureRestAdmin (MarqueVoitureAdminService service, MarqueVoitureConverter converter) {
