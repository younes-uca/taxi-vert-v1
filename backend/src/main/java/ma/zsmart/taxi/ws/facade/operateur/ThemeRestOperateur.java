...
@RestController
@RequestMapping("/api/operateur/theme")
public class ThemeRestOperateur  extends AbstractController<Theme, ThemeDto, ThemeHistory, ThemeCriteria, ThemeHistoryCriteria, ThemeOperateurService, ThemeConverter> {
...
//    }
    ...
    public ThemeRestOperateur (ThemeOperateurService service, ThemeConverter converter) {
