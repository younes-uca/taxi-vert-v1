...
@RestController
@RequestMapping("/api/chauffeur/etatCourse")
public class EtatCourseRestChauffeur  extends AbstractController<EtatCourse, EtatCourseDto, EtatCourseHistory, EtatCourseCriteria, EtatCourseHistoryCriteria, EtatCourseChauffeurService, EtatCourseConverter> {
...
//    }
    ...
    public EtatCourseRestChauffeur (EtatCourseChauffeurService service, EtatCourseConverter converter) {
