...
@RestController
@RequestMapping("/api/client/secteur")
public class SecteurRestClient  extends AbstractController<Secteur, SecteurDto, SecteurHistory, SecteurCriteria, SecteurHistoryCriteria, SecteurClientService, SecteurConverter> {
...
//    }
    ...
    public SecteurRestClient (SecteurClientService service, SecteurConverter converter) {
