...
@RestController
@RequestMapping("/api/client/langue")
public class LangueRestClient  extends AbstractController<Langue, LangueDto, LangueHistory, LangueCriteria, LangueHistoryCriteria, LangueClientService, LangueConverter> {
...
//    }
    ...
    public LangueRestClient (LangueClientService service, LangueConverter converter) {
