...
@RestController
@RequestMapping("/api/operateur/marqueVoiture")
public class MarqueVoitureRestOperateur  extends AbstractController<MarqueVoiture, MarqueVoitureDto, MarqueVoitureHistory, MarqueVoitureCriteria, MarqueVoitureHistoryCriteria, MarqueVoitureOperateurService, MarqueVoitureConverter> {
...
//    }
    ...
    public MarqueVoitureRestOperateur (MarqueVoitureOperateurService service, MarqueVoitureConverter converter) {
