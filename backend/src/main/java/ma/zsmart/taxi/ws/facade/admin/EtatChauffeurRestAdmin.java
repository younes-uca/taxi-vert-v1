...
@RestController
@RequestMapping("/api/admin/etatChauffeur")
public class EtatChauffeurRestAdmin  extends AbstractController<EtatChauffeur, EtatChauffeurDto, EtatChauffeurHistory, EtatChauffeurCriteria, EtatChauffeurHistoryCriteria, EtatChauffeurAdminService, EtatChauffeurConverter> {
...
//    }
    ...
    public EtatChauffeurRestAdmin (EtatChauffeurAdminService service, EtatChauffeurConverter converter) {
