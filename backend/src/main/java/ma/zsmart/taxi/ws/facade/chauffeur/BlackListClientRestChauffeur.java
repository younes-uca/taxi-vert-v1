...
@RestController
@RequestMapping("/api/chauffeur/blackListClient")
public class BlackListClientRestChauffeur  extends AbstractController<BlackListClient, BlackListClientDto, BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientChauffeurService, BlackListClientConverter> {
...
//    }
    ...
    public BlackListClientRestChauffeur (BlackListClientChauffeurService service, BlackListClientConverter converter) {
