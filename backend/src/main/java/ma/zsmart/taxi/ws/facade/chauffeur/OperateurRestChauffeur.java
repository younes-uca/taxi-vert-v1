...
@RestController
@RequestMapping("/api/chauffeur/operateur")
public class OperateurRestChauffeur  extends AbstractController<Operateur, OperateurDto, OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurChauffeurService, OperateurConverter> {
...
//    }
    ...
    public OperateurRestChauffeur (OperateurChauffeurService service, OperateurConverter converter) {
