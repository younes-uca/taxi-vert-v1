...
@RestController
@RequestMapping("/api/chauffeur/chauffeur")
public class ChauffeurRestChauffeur  extends AbstractController<Chauffeur, ChauffeurDto, ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurChauffeurService, ChauffeurConverter> {
...
//    }
    ...
    public ChauffeurRestChauffeur (ChauffeurChauffeurService service, ChauffeurConverter converter) {
