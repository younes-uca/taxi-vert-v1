...
@RestController
@RequestMapping("/api/operateur/ville")
public class VilleRestOperateur  extends AbstractController<Ville, VilleDto, VilleHistory, VilleCriteria, VilleHistoryCriteria, VilleOperateurService, VilleConverter> {
...
//    }
    ...
    public VilleRestOperateur (VilleOperateurService service, VilleConverter converter) {
