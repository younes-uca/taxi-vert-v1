...
@RestController
@RequestMapping("/api/chauffeur/blackListChauffeur")
public class BlackListChauffeurRestChauffeur  extends AbstractController<BlackListChauffeur, BlackListChauffeurDto, BlackListChauffeurHistory, BlackListChauffeurCriteria, BlackListChauffeurHistoryCriteria, BlackListChauffeurChauffeurService, BlackListChauffeurConverter> {
...
//    }
    ...
    public BlackListChauffeurRestChauffeur (BlackListChauffeurChauffeurService service, BlackListChauffeurConverter converter) {
