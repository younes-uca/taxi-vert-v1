...
@RestController
@RequestMapping("/api/operateur/chauffeur")
public class ChauffeurRestOperateur  extends AbstractController<Chauffeur, ChauffeurDto, ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurOperateurService, ChauffeurConverter> {
...
//    }
    ...
    public ChauffeurRestOperateur (ChauffeurOperateurService service, ChauffeurConverter converter) {
