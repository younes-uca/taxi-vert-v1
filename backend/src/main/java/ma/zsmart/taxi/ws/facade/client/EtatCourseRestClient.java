...
@RestController
@RequestMapping("/api/client/etatCourse")
public class EtatCourseRestClient  extends AbstractController<EtatCourse, EtatCourseDto, EtatCourseHistory, EtatCourseCriteria, EtatCourseHistoryCriteria, EtatCourseClientService, EtatCourseConverter> {
...
//    }
    ...
    public EtatCourseRestClient (EtatCourseClientService service, EtatCourseConverter converter) {
