...
@RestController
@RequestMapping("/api/client/etatChauffeur")
public class EtatChauffeurRestClient  extends AbstractController<EtatChauffeur, EtatChauffeurDto, EtatChauffeurHistory, EtatChauffeurCriteria, EtatChauffeurHistoryCriteria, EtatChauffeurClientService, EtatChauffeurConverter> {
...
//    }
    ...
    public EtatChauffeurRestClient (EtatChauffeurClientService service, EtatChauffeurConverter converter) {
