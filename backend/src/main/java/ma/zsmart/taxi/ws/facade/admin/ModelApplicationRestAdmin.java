...
@RestController
@RequestMapping("/api/admin/modelApplication")
public class ModelApplicationRestAdmin  extends AbstractController<ModelApplication, ModelApplicationDto, ModelApplicationHistory, ModelApplicationCriteria, ModelApplicationHistoryCriteria, ModelApplicationAdminService, ModelApplicationConverter> {
...
//    }
    ...
    public ModelApplicationRestAdmin (ModelApplicationAdminService service, ModelApplicationConverter converter) {
