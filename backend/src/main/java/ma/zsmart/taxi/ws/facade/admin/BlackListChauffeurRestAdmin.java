...
@RestController
@RequestMapping("/api/admin/blackListChauffeur")
public class BlackListChauffeurRestAdmin  extends AbstractController<BlackListChauffeur, BlackListChauffeurDto, BlackListChauffeurHistory, BlackListChauffeurCriteria, BlackListChauffeurHistoryCriteria, BlackListChauffeurAdminService, BlackListChauffeurConverter> {
...
//    }
    ...
    public BlackListChauffeurRestAdmin (BlackListChauffeurAdminService service, BlackListChauffeurConverter converter) {
