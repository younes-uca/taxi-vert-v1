...
@RestController
@RequestMapping("/api/admin/operateur")
public class OperateurRestAdmin  extends AbstractController<Operateur, OperateurDto, OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurAdminService, OperateurConverter> {
...
//    }
    ...
    public OperateurRestAdmin (OperateurAdminService service, OperateurConverter converter) {
