...
@RestController
@RequestMapping("/api/admin/chauffeur")
public class ChauffeurRestAdmin  extends AbstractController<Chauffeur, ChauffeurDto, ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurAdminService, ChauffeurConverter> {
...
//    }
    ...
    public ChauffeurRestAdmin (ChauffeurAdminService service, ChauffeurConverter converter) {
