...
@RestController
@RequestMapping("/api/client/blackListChauffeur")
public class BlackListChauffeurRestClient  extends AbstractController<BlackListChauffeur, BlackListChauffeurDto, BlackListChauffeurHistory, BlackListChauffeurCriteria, BlackListChauffeurHistoryCriteria, BlackListChauffeurClientService, BlackListChauffeurConverter> {
...
//    }
    ...
    public BlackListChauffeurRestClient (BlackListChauffeurClientService service, BlackListChauffeurConverter converter) {
