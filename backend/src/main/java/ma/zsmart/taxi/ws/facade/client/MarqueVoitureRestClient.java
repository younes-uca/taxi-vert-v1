...
@RestController
@RequestMapping("/api/client/marqueVoiture")
public class MarqueVoitureRestClient  extends AbstractController<MarqueVoiture, MarqueVoitureDto, MarqueVoitureHistory, MarqueVoitureCriteria, MarqueVoitureHistoryCriteria, MarqueVoitureClientService, MarqueVoitureConverter> {
...
//    }
    ...
    public MarqueVoitureRestClient (MarqueVoitureClientService service, MarqueVoitureConverter converter) {
