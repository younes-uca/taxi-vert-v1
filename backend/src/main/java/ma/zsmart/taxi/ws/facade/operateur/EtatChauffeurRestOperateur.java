...
@RestController
@RequestMapping("/api/operateur/etatChauffeur")
public class EtatChauffeurRestOperateur  extends AbstractController<EtatChauffeur, EtatChauffeurDto, EtatChauffeurHistory, EtatChauffeurCriteria, EtatChauffeurHistoryCriteria, EtatChauffeurOperateurService, EtatChauffeurConverter> {
...
//    }
    ...
    public EtatChauffeurRestOperateur (EtatChauffeurOperateurService service, EtatChauffeurConverter converter) {
