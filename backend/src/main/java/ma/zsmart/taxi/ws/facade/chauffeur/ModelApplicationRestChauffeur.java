...
@RestController
@RequestMapping("/api/chauffeur/modelApplication")
public class ModelApplicationRestChauffeur  extends AbstractController<ModelApplication, ModelApplicationDto, ModelApplicationHistory, ModelApplicationCriteria, ModelApplicationHistoryCriteria, ModelApplicationChauffeurService, ModelApplicationConverter> {
...
//    }
    ...
    public ModelApplicationRestChauffeur (ModelApplicationChauffeurService service, ModelApplicationConverter converter) {
