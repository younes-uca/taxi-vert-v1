...
public class SecteurRestAdmin  extends AbstractController<Secteur, SecteurDto, SecteurHistory, SecteurCriteria, SecteurHistoryCriteria, SecteurAdminService, SecteurConverter> {
