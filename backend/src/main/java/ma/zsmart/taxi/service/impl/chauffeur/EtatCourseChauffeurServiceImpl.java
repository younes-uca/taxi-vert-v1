...
import ma.zsmart.taxi.service.facade.chauffeur.EtatCourseChauffeurService;
...
@Service
public class EtatCourseChauffeurServiceImpl extends AbstractServiceImpl<EtatCourse, EtatCourseDto,EtatCourseHistory, EtatCourseCriteria, EtatCourseHistoryCriteria, EtatCourseDao,
EtatCourseHistoryDao, EtatCourseConverter> implements EtatCourseChauffeurService {

    public EtatCourseChauffeurServiceImpl(EtatCourseDao dao, EtatCourseHistoryDao historyDao, EtatCourseConverter converter) {
