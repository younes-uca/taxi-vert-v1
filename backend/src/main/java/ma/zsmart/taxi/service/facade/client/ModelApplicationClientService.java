...
public interface ModelApplicationClientService extends IService<ModelApplication, ModelApplicationDto,ModelApplicationCriteria, ModelApplicationHistoryCriteria> {
