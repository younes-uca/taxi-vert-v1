...
import ma.zsmart.taxi.service.facade.admin.EtatCourseAdminService;
...
@Service
public class EtatCourseAdminServiceImpl extends AbstractServiceImpl<EtatCourse, EtatCourseDto,EtatCourseHistory, EtatCourseCriteria, EtatCourseHistoryCriteria, EtatCourseDao,
EtatCourseHistoryDao, EtatCourseConverter> implements EtatCourseAdminService {

    public EtatCourseAdminServiceImpl(EtatCourseDao dao, EtatCourseHistoryDao historyDao, EtatCourseConverter converter) {
