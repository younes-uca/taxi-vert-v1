...
import ma.zsmart.taxi.service.facade.chauffeur.MarqueTelephoneChauffeurService;
...
@Service
public class MarqueTelephoneChauffeurServiceImpl extends AbstractServiceImpl<MarqueTelephone, MarqueTelephoneDto,MarqueTelephoneHistory, MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria, MarqueTelephoneDao,
MarqueTelephoneHistoryDao, MarqueTelephoneConverter> implements MarqueTelephoneChauffeurService {

    public MarqueTelephoneChauffeurServiceImpl(MarqueTelephoneDao dao, MarqueTelephoneHistoryDao historyDao, MarqueTelephoneConverter converter) {
