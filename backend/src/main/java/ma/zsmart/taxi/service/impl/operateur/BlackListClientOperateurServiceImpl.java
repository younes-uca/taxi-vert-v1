...
import ma.zsmart.taxi.service.facade.operateur.BlackListClientOperateurService;
...
@Service
public class BlackListClientOperateurServiceImpl extends AbstractServiceImpl<BlackListClient, BlackListClientDto,BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientDao,
BlackListClientHistoryDao, BlackListClientConverter> implements BlackListClientOperateurService {

    public BlackListClientOperateurServiceImpl(BlackListClientDao dao, BlackListClientHistoryDao historyDao, BlackListClientConverter converter) {
