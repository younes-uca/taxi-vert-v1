...
import ma.zsmart.taxi.service.facade.operateur.ChauffeurOperateurService;
...
@Service
public class ChauffeurOperateurServiceImpl extends AbstractServiceImpl<Chauffeur, ChauffeurDto,ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurDao,
ChauffeurHistoryDao, ChauffeurConverter> implements ChauffeurOperateurService {

    public ChauffeurOperateurServiceImpl(ChauffeurDao dao, ChauffeurHistoryDao historyDao, ChauffeurConverter converter) {
