...
import ma.zsmart.taxi.service.facade.client.MarqueVoitureClientService;
...
@Service
public class MarqueVoitureClientServiceImpl extends AbstractServiceImpl<MarqueVoiture, MarqueVoitureDto,MarqueVoitureHistory, MarqueVoitureCriteria, MarqueVoitureHistoryCriteria, MarqueVoitureDao,
MarqueVoitureHistoryDao, MarqueVoitureConverter> implements MarqueVoitureClientService {

    public MarqueVoitureClientServiceImpl(MarqueVoitureDao dao, MarqueVoitureHistoryDao historyDao, MarqueVoitureConverter converter) {
