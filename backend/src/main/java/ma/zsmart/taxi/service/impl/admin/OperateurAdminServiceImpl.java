...
import ma.zsmart.taxi.service.facade.admin.OperateurAdminService;
...
@Service
public class OperateurAdminServiceImpl extends AbstractServiceImpl<Operateur, OperateurDto,OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurDao,
OperateurHistoryDao, OperateurConverter> implements OperateurAdminService {

    public OperateurAdminServiceImpl(OperateurDao dao, OperateurHistoryDao historyDao, OperateurConverter converter) {
