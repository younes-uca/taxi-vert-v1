...
import ma.zsmart.taxi.service.facade.chauffeur.OperateurChauffeurService;
...
@Service
public class OperateurChauffeurServiceImpl extends AbstractServiceImpl<Operateur, OperateurDto,OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurDao,
OperateurHistoryDao, OperateurConverter> implements OperateurChauffeurService {

    public OperateurChauffeurServiceImpl(OperateurDao dao, OperateurHistoryDao historyDao, OperateurConverter converter) {
