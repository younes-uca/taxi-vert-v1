...
import ma.zsmart.taxi.service.facade.admin.ModelApplicationAdminService;
...
@Service
public class ModelApplicationAdminServiceImpl extends AbstractServiceImpl<ModelApplication, ModelApplicationDto,ModelApplicationHistory, ModelApplicationCriteria, ModelApplicationHistoryCriteria, ModelApplicationDao,
ModelApplicationHistoryDao, ModelApplicationConverter> implements ModelApplicationAdminService {

    public ModelApplicationAdminServiceImpl(ModelApplicationDao dao, ModelApplicationHistoryDao historyDao, ModelApplicationConverter converter) {
