...
@Service
public class MoyenTransportChauffeurServiceImpl extends AbstractServiceImpl<MoyenTransport, MoyenTransportDto,MoyenTransportHistory, MoyenTransportCriteria, MoyenTransportHistoryCriteria, MoyenTransportDao,
MoyenTransportHistoryDao, MoyenTransportConverter> implements MoyenTransportChauffeurService {

    public MoyenTransportChauffeurServiceImpl(MoyenTransportDao dao, MoyenTransportHistoryDao historyDao, MoyenTransportConverter converter) {
