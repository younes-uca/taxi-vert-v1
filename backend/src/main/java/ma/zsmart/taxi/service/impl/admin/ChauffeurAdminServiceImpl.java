...
import ma.zsmart.taxi.service.facade.admin.ChauffeurAdminService;
...
@Service
public class ChauffeurAdminServiceImpl extends AbstractServiceImpl<Chauffeur, ChauffeurDto,ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurDao,
ChauffeurHistoryDao, ChauffeurConverter> implements ChauffeurAdminService {

    public ChauffeurAdminServiceImpl(ChauffeurDao dao, ChauffeurHistoryDao historyDao, ChauffeurConverter converter) {
