...
import ma.zsmart.taxi.service.facade.chauffeur.ChauffeurChauffeurService;
...
@Service
public class ChauffeurChauffeurServiceImpl extends AbstractServiceImpl<Chauffeur, ChauffeurDto,ChauffeurHistory, ChauffeurCriteria, ChauffeurHistoryCriteria, ChauffeurDao,
ChauffeurHistoryDao, ChauffeurConverter> implements ChauffeurChauffeurService {

    public ChauffeurChauffeurServiceImpl(ChauffeurDao dao, ChauffeurHistoryDao historyDao, ChauffeurConverter converter) {
