...
public interface MarqueTelephoneChauffeurService extends IService<MarqueTelephone, MarqueTelephoneDto,MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria> {
