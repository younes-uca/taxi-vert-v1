...
@Service
public class CourseClientServiceImpl extends AbstractServiceImpl<Course, CourseDto,CourseHistory, CourseCriteria, CourseHistoryCriteria, CourseDao,
CourseHistoryDao, CourseConverter> implements CourseClientService {

    public CourseClientServiceImpl(CourseDao dao, CourseHistoryDao historyDao, CourseConverter converter) {
