...
import ma.zsmart.taxi.service.facade.admin.BlackListClientAdminService;
...
@Service
public class BlackListClientAdminServiceImpl extends AbstractServiceImpl<BlackListClient, BlackListClientDto,BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientDao,
BlackListClientHistoryDao, BlackListClientConverter> implements BlackListClientAdminService {

    public BlackListClientAdminServiceImpl(BlackListClientDao dao, BlackListClientHistoryDao historyDao, BlackListClientConverter converter) {
