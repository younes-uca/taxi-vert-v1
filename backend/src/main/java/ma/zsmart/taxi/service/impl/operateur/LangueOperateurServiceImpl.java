...
import ma.zsmart.taxi.service.facade.operateur.LangueOperateurService;
...
@Service
public class LangueOperateurServiceImpl extends AbstractServiceImpl<Langue, LangueDto,LangueHistory, LangueCriteria, LangueHistoryCriteria, LangueDao,
LangueHistoryDao, LangueConverter> implements LangueOperateurService {

    public LangueOperateurServiceImpl(LangueDao dao, LangueHistoryDao historyDao, LangueConverter converter) {
