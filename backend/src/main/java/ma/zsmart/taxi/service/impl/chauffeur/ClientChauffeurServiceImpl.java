...
import ma.zsmart.taxi.service.facade.chauffeur.ClientChauffeurService;
...
@Service
public class ClientChauffeurServiceImpl extends AbstractServiceImpl<Client, ClientDto,ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientDao,
ClientHistoryDao, ClientConverter> implements ClientChauffeurService {

    public ClientChauffeurServiceImpl(ClientDao dao, ClientHistoryDao historyDao, ClientConverter converter) {
