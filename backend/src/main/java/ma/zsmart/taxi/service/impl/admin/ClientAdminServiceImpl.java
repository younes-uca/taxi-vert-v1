...
@Service
public class ClientAdminServiceImpl extends AbstractServiceImpl<Client, ClientDto,ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientDao,
ClientHistoryDao, ClientConverter> implements ClientAdminService {

    public ClientAdminServiceImpl(ClientDao dao, ClientHistoryDao historyDao, ClientConverter converter) {
