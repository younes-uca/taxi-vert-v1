...
import ma.zsmart.taxi.service.facade.client.BlackListChauffeurClientService;
...
@Service
public class BlackListChauffeurClientServiceImpl extends AbstractServiceImpl<BlackListChauffeur, BlackListChauffeurDto,BlackListChauffeurHistory, BlackListChauffeurCriteria, BlackListChauffeurHistoryCriteria, BlackListChauffeurDao,
BlackListChauffeurHistoryDao, BlackListChauffeurConverter> implements BlackListChauffeurClientService {

    public BlackListChauffeurClientServiceImpl(BlackListChauffeurDao dao, BlackListChauffeurHistoryDao historyDao, BlackListChauffeurConverter converter) {
