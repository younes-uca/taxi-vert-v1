...
public interface ModelApplicationAdminService extends IService<ModelApplication, ModelApplicationDto,ModelApplicationCriteria, ModelApplicationHistoryCriteria> {
