...
import ma.zsmart.taxi.service.facade.client.ModelApplicationClientService;
...
@Service
public class ModelApplicationClientServiceImpl extends AbstractServiceImpl<ModelApplication, ModelApplicationDto,ModelApplicationHistory, ModelApplicationCriteria, ModelApplicationHistoryCriteria, ModelApplicationDao,
ModelApplicationHistoryDao, ModelApplicationConverter> implements ModelApplicationClientService {

    public ModelApplicationClientServiceImpl(ModelApplicationDao dao, ModelApplicationHistoryDao historyDao, ModelApplicationConverter converter) {
