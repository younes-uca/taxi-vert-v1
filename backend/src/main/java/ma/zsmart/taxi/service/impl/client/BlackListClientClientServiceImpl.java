...
@Service
public class BlackListClientClientServiceImpl extends AbstractServiceImpl<BlackListClient, BlackListClientDto,BlackListClientHistory, BlackListClientCriteria, BlackListClientHistoryCriteria, BlackListClientDao,
BlackListClientHistoryDao, BlackListClientConverter> implements BlackListClientClientService {

    public BlackListClientClientServiceImpl(BlackListClientDao dao, BlackListClientHistoryDao historyDao, BlackListClientConverter converter) {
