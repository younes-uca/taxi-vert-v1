...
import ma.zsmart.taxi.service.facade.client.SecteurClientService;
...
@Service
public class SecteurClientServiceImpl extends AbstractServiceImpl<Secteur, SecteurDto,SecteurHistory, SecteurCriteria, SecteurHistoryCriteria, SecteurDao,
SecteurHistoryDao, SecteurConverter> implements SecteurClientService {

    public SecteurClientServiceImpl(SecteurDao dao, SecteurHistoryDao historyDao, SecteurConverter converter) {
