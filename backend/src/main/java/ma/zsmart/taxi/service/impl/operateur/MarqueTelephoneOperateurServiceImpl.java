...
@Service
public class MarqueTelephoneOperateurServiceImpl extends AbstractServiceImpl<MarqueTelephone, MarqueTelephoneDto,MarqueTelephoneHistory, MarqueTelephoneCriteria, MarqueTelephoneHistoryCriteria, MarqueTelephoneDao,
MarqueTelephoneHistoryDao, MarqueTelephoneConverter> implements MarqueTelephoneOperateurService {

    public MarqueTelephoneOperateurServiceImpl(MarqueTelephoneDao dao, MarqueTelephoneHistoryDao historyDao, MarqueTelephoneConverter converter) {
