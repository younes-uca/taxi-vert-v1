...
@Service
public class SecteurOperateurServiceImpl extends AbstractServiceImpl<Secteur, SecteurDto,SecteurHistory, SecteurCriteria, SecteurHistoryCriteria, SecteurDao,
SecteurHistoryDao, SecteurConverter> implements SecteurOperateurService {

    public SecteurOperateurServiceImpl(SecteurDao dao, SecteurHistoryDao historyDao, SecteurConverter converter) {
